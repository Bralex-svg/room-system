...
function Book() {
  ...
  return (
    <>
      <h1 className="absolute top-[20px] text-5xl font-bold ml-[25%] text-white">
        BOOK FOR A RESERVATION.
      </h1>
      <h2 className="absolute top-[270px] w-[35%] text-5xl font-medium ml-[10%] text-white">
        The hall is in use for the{" "}
        <span className="text-blue-900">next 5 hours.</span>
      </h2>
        ...
        <div>
          <form className="max-w-[550px] mt-[2%]   h-[520px] w-[300px] sm:w-[400px]  ">
            ...
            <div className="mb-3 xl:w-96">
              ...
              >
                <option value="Venue">Choose your venue</option>
